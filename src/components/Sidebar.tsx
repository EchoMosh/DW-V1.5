...
import { Search, Bell, MessageCircle, Rocket, Presentation, BarChart3, Users, ChevronRight, User } from "lucide-react";
      ...
      ">
          ...
          <header className="flex items-center justify-between px-4 pt-4 pb-3">
            ...
            scale: 1.02
              ...
              <div className="font-serif text-lg text-white">Dreamwell</div>
            </div>
            <div className="flex items-center gap-2">
              {['search', 'bell'].map(k => <motion.button key={k} whileHover={{
            scale: 1.05
          }} whileTap={{
            scale: 0.95
          }} className="
        ...
        scale: 0.98
          ...
          <div className="px-4 flex-1 overflow-y-auto scrollbar-none">
            ...
            <div className="space-y-1">
              {features.map(feature => <FeatureItem key={feature.label} active={feature.active} icon={feature.icon} label={feature.label} />)}
            </div>
          ...
          <footer className="mt-auto p-4">
            ...
            ">
              ...
              delay: 0.1
            }} className="absolute w-6 h-6 rounded-full bg-blue-500 border-2 border-white/20 flex items-center justify-center" style={{
              ...
              delay: 0.2
            }} className="absolute w-6 h-6 rounded-full bg-green-500 border-2 border-white/20 flex items-center justify-center" style={{
              ...
              delay: 0.3
            }} className="absolute w-6 h-6 rounded-full bg-purple-500 border-2 border-white/20 flex items-center justify-center" style={{
